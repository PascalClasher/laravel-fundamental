...
<div class="hero container">
    <div class="row" style="height:600px;">
        <div class="col-md-8 my-auto px-5">
            ...
            <h1 class="fw-bold" style="font-size: 55px">🌟 Red Velvet Latte! 🌟</h1>
...
<div class="mx-lg-5 mt-lg-5 mb-lg-3">
    <div class="rounded bg-dark pt-3 pb-3">
    <h2 class="text-center fw-bold mt-2" style="color: azure">PRODUCTS</h2>
                                ...
                                <div class="card bg-white w-100">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between">
                                            <p class="card-title fw-bold my-auto" style="font-size: 24px">{{ $product['menu'] }}
                                            </p>
